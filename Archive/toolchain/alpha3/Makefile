...
HoangFlag = -I/home/hoang/blackroo/toolchain/mipsel/usr/local/lib/gcc-lib/mipsel-linux/egcs-2.91.66/include -I/home/hoang/blackroo/toolchain/mipsel/usr/local/include
HOSTCC  	= gcc
...
CFLAGS := $(CPPFLAGS) $(HoangFlag) -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer -fno-strict-aliasing
else
CFLAGS := $(CPPFLAGS) $(HoangFlag) -Wall -Wstrict-prototypes -O1 -g -fno-strict-aliasing
endif
...
ifndef CONFIG_UCLINUX
	...
	CFLAGS	   += -DNO_MM -DNO_FPU
	AFLAGS	   += -DNO_MM -DNO_FPU
	CORE_FILES += mmnommu/mmnommu.o
	SUBDIRS    += mmnommu
endif
